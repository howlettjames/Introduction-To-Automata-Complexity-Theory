...
int main(void)
{
	...
	for(;;)
	{
		...
		switch(option)
		{
			case 1: case 2:
			system("cls");
			write_fp = fopen("C:/Users/Jaime/Documents/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/CFG_1/Automata_Record.txt", "w");
			write_shape = fopen("C:/Users/Jaime/Documents/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/CFG_1/Shape.txt", "w");
			if(option == 1)
			{
			...
			break;
			case 3:
			system("C:/Users/Jaime/Documents/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/CFG_1/Automata_Record.txt");
			system("cls");
			break;
			case 4:
			system("C:/Users/Jaime/Documents/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/CFG_1/Shape.txt");
			system("cls");
			break;
			case 5:
			system("cls");
