...
int main (void)
{
	...
	for(;;)
	{
		...
		{
			system("C:/Users/Daniela/Documents/JAMES/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/CHESS/Successful_Trails.txt");
			proceed = false;
		}
		else if(option == 5)
		{
			system("C:/Users/Daniela/Documents/JAMES/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/CHESS/Trails.txt");
			proceed = false;
		}
		else if(option == 6)
		{
		...
		if(proceed == true)
		{
			...
			if((write_trails_fp = fopen("C:/Users/Daniela/Documents/JAMES/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/CHESS/Trails.txt", "w")) == NULL)
			{
			...
			{
				if((write_success_fp = fopen("C:/Users/Daniela/Documents/JAMES/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/CHESS/Successful_Trails.txt", "w")) == NULL)
				{
