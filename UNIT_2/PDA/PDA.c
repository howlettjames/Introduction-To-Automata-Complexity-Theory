	...
	for(;;)
	{
		...
		switch(option)
		{
			case 1: case 2: case 3:
				system("cls");
				getchar(); //Catches the '\n' entered by the user
				write_fp = fopen("C:/Users/Daniela/Documents/JAMES/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/PDA/Automata_Record.txt", "w");
				if(option == 1)
				{
			...
			case 4:
				system("cls");
				system("C:/Users/Daniela/Documents/JAMES/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/PDA/Automata_Record.txt");
			break;
			case 5:
				system("cls");
				exit(EXIT_SUCCESS);
