...
int main(void)
{
	...
	for(;;)
	{
		...
		switch(option)
		{
			case 1:
			system("cls");
			if((write_fp = fopen("C:/Users/Jaime/Documents/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/RE_2/Automata_Record.txt", "w")) == NULL)
			{
			...
			break;
			case 2:
			system("C:/Users/Jaime/Documents/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/RE_2/Automata_Record.txt");
			break;
			case 3:
			system("cls");
			exit(EXIT_SUCCESS);
