...
int main (void)
{
	...
	for(;;)
	{
		...
		switch(option)
		{
			...
			if((write_fp = fopen("C:/Users/Jaime/Documents/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/WEBAY/Automata_Record.txt", "w")) == NULL)
			{
			...
			break;
			case 4:
			system("C:/Users/Jaime/Documents/ESCOM_SEMESTRE_4/2CM5_TEORIA_COMPUTACIONAL/UNIT_2/WEBAY/Automata_Record.txt");
			break;
			case 5:
			system("cls");
			exit(EXIT_SUCCESS);
